...
const styles: { [key in ButtonVariant]: { [key in ButtonColor]: string } } = {
  flat: {
    ...
    background: `${baseStyles} bg-transparent text-ev-light hover:bg-ev-light-hard/20 pressed:bg-ev-light-harder dark:text-ev-light dark:hover:bg-ev-light-hard/20 pressed:dark:text-ev-light-harder disabled:text-ev-light/40`,
  },
  solid: {
    ...
    background: `${baseStyles} bg-ev-light text-ev-dark hover:bg-ev-light-hard pressed:bg-ev-light-harder dark:text-ev-light dark:bg-ev-dark dark:hover:bg-ev-dark-hard  dark:pressed:bg-ev-light-harder disabled:bg-ev-dark-hard/40`,
  },
};

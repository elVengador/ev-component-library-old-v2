...
const styles: { [key in ButtonVariant]: { [key in ButtonColor]: string } } = {
  flat: {
    ...
    background: `${baseStyles} bg-transparent text-ev-light data-[hovered]:bg-ev-light/20 data-[pressed]:bg-ev-light/40 dark:text-ev-dark dark:data-[hovered]:bg-ev-dark/20 data-[pressed]:dark:bg-ev-dark/40 disabled:text-ev-light/40`,
  },
  solid: {
    primary: `${baseStyles} bg-ev-primary data-[hovered]:bg-ev-primary-hard data-[pressed]:bg-ev-primary-harder text-ev-light disabled:bg-ev-primary/40`,
    secondary: `${baseStyles} bg-ev-secondary data-[hovered]:bg-ev-secondary-hard data-[pressed]:bg-ev-primary-harder text-ev-light disabled:bg-ev-secondary-hard/40`,
    destructive: `${baseStyles} bg-ev-destructive data-[hovered]:bg-ev-destructive-hard data-[pressed]:bg-ev-destructive-harder text-ev-light disabled:bg-ev-destructive-hard/40`,
    foreground: `${baseStyles} bg-ev-dark text-ev-light data-[hovered]:bg-ev-dark-hard data-[pressed]:bg-ev-dark-harder dark:bg-ev-light dark:text-ev-dark dark:data-[hovered]:bg-ev-light-hard  dark:data-[pressed]:bg-ev-light-harder disabled:bg-ev-dark-hard/40`,
    background: `${baseStyles} bg-ev-light text-ev-dark data-[hovered]:bg-ev-light-hard data-[pressed]:bg-ev-light-harder dark:text-ev-light dark:bg-ev-dark dark:data-[hovered]:bg-ev-dark-hard  dark:data-[pressed]:bg-ev-light-harder disabled:bg-ev-dark-hard/40`,
  },
};
